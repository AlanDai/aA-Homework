...
View.prototype.exercise4 = function () {
  ...
  //your code here!
  $(".square:nth-child(2n)").each(function (index) {
    this.textContent = "Alan";
  })
...
View.prototype.exercise5 = function () {
  ...
  $(".square").on("click", event => {
    const [x,y] = $(event.currentTarget).attr("data-pos").split(",");
    alert(`${x}, ${y}`)
  });
};
...
View.prototype.exercise6 = function () {
  ...
  $squares.each(function (index, obj) {
    $(obj).css("background-color", window._randomColorString());
  });
};
